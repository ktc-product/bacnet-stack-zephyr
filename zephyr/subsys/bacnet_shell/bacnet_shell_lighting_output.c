...
static void cmd_lighting_output_value_relinquish(
...
static void cmd_lighting_output_step(
...
cmd_lighting_output_step_up(const struct shell *shell, int argc, char **argv)
{
    ...
    cmd_lighting_output_step(shell, argc, argv, operation);
}
...
static void cmd_lighting_output_blink(
    const struct shell *shell,
    int argc,
    char **argv,
    BACNET_LIGHTING_OPERATION operation)
...
cmd_lighting_output_blink_warn(const struct shell *shell, int argc, char **argv)
{
    ...
    cmd_lighting_output_blink(shell, argc, argv, operation);
}

static void cmd_lighting_output_blink_warn_off(
    const struct shell *shell, int argc, char **argv)
{
...
static void cmd_lighting_output_blink_warn_relinquish(
    const struct shell *shell, int argc, char **argv)
{
